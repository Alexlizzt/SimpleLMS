 ...
 * @endcode
 */
$settings['hash_salt'] = 'GUxSj7WMCRzuHnABA3ioxeNX4SHLT47h0I-1KVvWdur_VIsOEqfUycS1Z1pVxAo3RBuk8D4omw';
...
/**
 * Configuración automática de Correo para Entorno Docker (Mailpit).
 */
$config['system.mail']['interface']['default'] = 'smtp';

$config['smtp.settings'] = [
  'smtp_on' => TRUE,            // Activa el módulo SMTP automáticamente
  'smtp_host' => 'mailpit',     // Nombre del servicio en docker-compose.yml
  'smtp_port' => '1025',        // Puerto estándar de Mailpit
  'smtp_protocol' => 'none',    // Mailpit local no requiere SSL/TLS
  'smtp_authed' => FALSE,       // No requiere usuario/contraseña
...
$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^127\.0\.0\.1$',
  '^lms-drupal\.ddev\.site$', // O el dominio que uses en tu Docker
];
